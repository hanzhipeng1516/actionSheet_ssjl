    ...
    MobileArea.prototype = {
        ...
        bindEvent: function () {
            ...
            function popupArea(e) {
                _self._view = document.createElement("div");
                _self._view.className = "_view";
                _self._view.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';
                document.body.appendChild(_self._view);
                areaCtrlInit();
                var larea_cancel = _self._view.querySelector(".larea_cancel");
                larea_cancel.addEventListener('touchstart', function (e) {
                    _self.close(e);
                });
                var larea_finish = _self._view.querySelector(".larea_finish");
                larea_finish.addEventListener('touchstart', function (e) {
                    _self.finish(e);
                });
                var area_province = _self._view.querySelector(".area_province");
                var area_city = _self._view.querySelector(".area_city");
                var area_county = _self._view.querySelector(".area_county");
            ...
            function areaCtrlInit() {
                ...
                _self._view.querySelector(".area_province").setAttribute("val", _self.value[0]);
                _self._view.querySelector(".area_city").setAttribute("val", _self.value[1]);
                _self._view.querySelector(".area_county").setAttribute("val", _self.value[2]);
        ...
        setGearTooth: function (data) {
            ...
            var item = data;
            var l = item.length;
            var gearChild = _self._view.querySelectorAll(".gear");
        ...
        close: function (e) {
            ...
            var area_ctrl = _self._view.querySelector(".area_ctrl");
            _self._view.removeChild(area_ctrl);
            document.body.removeChild(_self._view);
            _self._view = null;
        }
    };
    return MobileArea;
